...
{
  "agent": "devops",
  "action": "DEPLOY_COMPLETE | ROLLBACK",
  "pr_id": "PR-XXX",
  "ticket_ref": "PROJ-XXX",
  ...
  "smoke_tests_result": "PASS | FAIL",
  "production_result": "PASS | ROLLBACK",

  "monitoring_window": {
    "duration_minutes": 15,
    "error_rate_baseline": "X%",
    "error_rate_observed": "X%",
    "latency_p95_baseline": "Xms",
    "latency_p95_observed": "Xms",
    "status": "CLEAR | DEGRADED"
  },
  ...
  "next_action": "TICKET_DONE | RETURN_TO_DEVELOPER"
}
```
