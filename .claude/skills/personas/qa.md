...
## SDLC QA Loop — Test Execution Output
...
```json
{
  ...
  "test_cases": [
    {
      "id": "TC-001",
      "acceptance_criterion": "<exact AC text from ticket>",
      "preconditions": "<system state>",
      "steps": ["1. ...", "2. ..."],
      "expected": "<expected result>",
      "actual": "<actual result — fill if FAIL>",
  ...
  "bugs_filed": [
    { "id": "BUG-XXX", "severity": "P0|P1|P2|P3", "blocking": true }
  ],
