  ...
  "patterns_observed": [
    {
      ...
      "root_cause_hypothesis": "Auth pattern not documented clearly enough in CLAUDE.md",
...
```json
{
  ...
  "consultation_requested": null,

  "pattern_log": [],

  "summary": "<one paragraph: what's good, what needs fixing, overall assessment>",
